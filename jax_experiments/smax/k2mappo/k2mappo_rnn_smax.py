...
def make_train(config):
    ...
    def train(rng, run_idx):
        ...
        # training loop
        def _train_loop(update_runner_state, unused):
            ...
            env_state_initial = env_state
            obsv_initial = obsv
            done_initial = done
            hstates_initial = hstates
            hstates_initial_k = hstates

            def _update_step_k1(initial_runner_state, unused):
                #     runner_state = (
                ...
                initial_hstates = initial_runner_state[-2]
                ...
                final_runner_state, traj_batch = jax.lax.scan(
                    _env_step, initial_runner_state, None, config["NUM_STEPS"]
                )

                # CALCULATE ADVANTAGE
                train_states, env_state, last_obs, last_done, last_hstates, rng = (
                    final_runner_state
                )
                ...
                def _update_epoch(update_state, unused):
                    ...
                    # add extra leading dimensio to hstates
        ...
        final_runner_state, metrics_list = jax.lax.scan(
            _train_loop, (initial_runner_state, 0), None, config["NUM_UPDATES"]
        )
