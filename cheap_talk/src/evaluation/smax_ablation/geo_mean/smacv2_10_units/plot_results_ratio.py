...
for alg in alg_names:
    fn_path_al = Path(data_path) / f"{alg}_ratio.npy"
...
plt.savefig(fname=str(fn_path) + f"/{env_name}_ratio.jpg", bbox_inches="tight")
plt.savefig(fname=str(fn_path) + f"/{env_name}_ratio.pdf", bbox_inches="tight")
